...
export const tools = [
  ...
  },
  {
    slug: 'calendar',
    href: '/calendar/1448/',
    titleAr: 'التقويم الهجري 1448',
    shortAr: 'التقويم الهجري 1448',
    descAr: 'التقويم الهجري لعام 1448 هـ كاملًا بجميع الأشهر والأيام والمناسبات الإسلامية، مع ما يقابلها بالتاريخ الميلادي. اعرف بداية الأشهر والأعياد والإجازات مجانًا.',
    category: 'date',
    type: 'calc',
    icon: '🗓️',
    live: true,
